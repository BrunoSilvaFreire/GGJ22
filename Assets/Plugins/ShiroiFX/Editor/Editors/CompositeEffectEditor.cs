...
namespace Shiroi.FX.Editor.Editors {
    ...
    public class CompositeEffectEditor : UnityEditor.Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            var buttonRect = Event.current.type == EventType.Repaint ? GUILayoutUtility.GetLastRect() : default;
        ...
        private void DrawFX<T>(T worldFX, GUISkin skin, out bool remove) where T : ScriptableObject {
            EditorGUILayout.BeginHorizontal();
            if (worldFX == null) {
                EditorGUILayout.LabelField(ShiroiFXEditorResources.NullFXError, Styles.CN_StatusError,
