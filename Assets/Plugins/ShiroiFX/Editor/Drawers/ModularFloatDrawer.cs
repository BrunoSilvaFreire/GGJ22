    ...
    public class ModularFloatDrawer : PropertyDrawer {
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label) {
            ...
            if (source != PropertySource.Context) {
                ...
                var mode = (ModularRange.RangeMode) property.FindPropertyRelative("Value").FindPropertyRelative("Mode")
                    .enumValueIndex;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            EditorGUI.PropertyField(valRect,
                isProvidedByEffect ? property.FindPropertyRelative("Value") : property.FindPropertyRelative("TagName"));
